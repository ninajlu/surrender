    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-green-50 to-white">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="prose prose-lg max-w-none prose-headings:font-bold">
          ...
          <p>
            The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, unless 
            otherwise defined in this Privacy Policy.
          </p>

          <h2 className="text-2xl font-extrabold text-gray-900 mt-8 mb-4">Information Collection and Use</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-8 mb-4">Service Providers</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-8 mb-4">Cookies</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-8 mb-4">Children's Privacy</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-8 mb-4">Log Data</h2>
          <p>
            We want to inform you that whenever you use our Service, in a case of an error we collect data and 
            information called Log Data. This Log Data may include information such as your device Internet Protocol 
            ("IP") address, device name, operating system version, the configuration when utilizing our Service, 
            the time and date of your use of the Service, and other statistics.
          </p>

          <h2 className="text-2xl font-extrabold text-gray-900 mt-8 mb-4">Security</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-8 mb-4">Links to Other Sites</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mt-8 mb-4">Changes to This Privacy Policy</h2>
          <p>
